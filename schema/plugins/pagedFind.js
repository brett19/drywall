...
module.exports = exports = function pagedFindPlugin(model) {
  model.pagedFind = function(options, callback) {
    if (!options.filters) {
      options.filters = {};
    }
    ...
    var countResults = function(callback) {
      model.count(options.filters, function(err, count) {
